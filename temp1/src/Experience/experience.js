  ...
  render() {
    ...
    return (
      <div id="home-experience" className="bg-dark">
        ...
        <div className="experience-bottom-grid" onClick={() => { this.upload.click() }}>
          <img className="experience-bottom-item" src="https://images.unsplash.com/photo-1549989476-69a92fa57c36?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60"
            alt={faker.image.people()}></img>
          <img className="experience-bottom-item" src="https://images.unsplash.com/photo-1549396535-c11d5c55b9df?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60"
            alt={faker.image.people()}></img>
          <img className="experience-bottom-item" src="https://images.unsplash.com/photo-1550133730-695473e544be?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60"
            alt={faker.image.people()}></img>
        </div>
